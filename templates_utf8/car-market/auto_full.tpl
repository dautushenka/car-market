...
<table width="100%" style="margin-bottom: 10px;">
	<tr>
		<td colspan="2" align="left" class="ntitle">Подробная информация</td>
	</tr>
	[exist_photo]
	<tr>
	...
	<tr>
		<td colspan="2">[row_photo separator="<br />
		" count="4"]{photo} &nbsp;[/row_photo]</td>
	</tr>
	[/exist_photo]
	<tr>
	...
	<tr>
		...
		<td style="padding: 5px;">{cost} [auction](торг уместен)[/auction] &nbsp; [exchange](возможен обмен)[/exchange]</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="padding: 5px;">[email]<img border="0"
			src="{THEME}/car-market/images/email.png"
			title="Задать вопрос владельцу по email" />[/email]</td>
	</tr>
	[phone]
	<tr>
	...
	<tr>
		...
		{send_mail}&nbsp;&nbsp;{favorites}&nbsp;&nbsp;[print]Печать[/print]&nbsp;&nbsp;[edit]<img
			src="{THEME}/images/edit.png" title="Редактировать объявление"
			border="0">[/edit]&nbsp;&nbsp;{info} Просмотров {view_count}&nbsp;&nbsp; Автор <a href="{cars_of_author}" >{author}</a></td>
	</tr>
</table>
